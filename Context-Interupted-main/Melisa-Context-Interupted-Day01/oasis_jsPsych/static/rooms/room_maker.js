...
function create_memory_stimulus(blue_val,curr_blue_memory,blue_background){
  return parse("<h1>%s</h1><br><br><h2>Can you imagine the word with the color? </h2><br><h2> Y or N </h2><style>body {background-color: %s;}</style>",blue_val[curr_blue_memory],blue_background)
}
